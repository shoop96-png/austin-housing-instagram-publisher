...
Approval-gated Instagram publishing for **Austin Housing Brief**.

## How it works

1. The weekday ChatGPT automation prepares a finished image and caption.
...
```json
{
  ...
  "credit_line": "Source and image credit",
